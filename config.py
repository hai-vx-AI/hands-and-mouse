...
SPIKE_MEDIAN_WINDOW = 3        # Cửa sổ trung vị (độ trễ siêu nhỏ)
...
KALMAN_LOCK_THRESHOLD = 5.0    # Vận tốc dưới ngưỡng này -> Chuột đứng im chống rung
KALMAN_UNLOCK_THRESHOLD = 20.0 # Lực bứt phá để chuột thoát khỏi trạng thái đứng im
...
DRAG_RADIUS = 15               # Bán kính Mỏ neo chống trượt khi Click (pixel)
...
HOLD_INTENT_FRAMES = 15        # (Khoảng 0.5s) Ranh giới phân định Ý định. Chờ quá số này -> Đổ bê tông Tua x2.